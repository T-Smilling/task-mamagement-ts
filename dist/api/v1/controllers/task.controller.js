...
exports.edit = exports.create = exports.deleted = exports.changeMulti = exports.changeStatus = exports.detail = exports.index = void 0;
...
const edit = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const taskId = req.params.id;
        yield task_model_1.default.updateOne({ _id: taskId }, req.body);
        res.json({
            code: 200,
